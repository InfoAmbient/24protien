...
(function(factory) {
    ...
    var pluginName = "intlTelInput", id = 964, // give each instance it's own id for namespaced event handling
    defaults = {
...
//                }
   ...
   ********************/
        ...
        _setFlag: function(countryCode) {
            ...
            var title = countryCode ? "+" + this.selectedCountryData.dialCode : "Unknown";
        ...
        _updatePlaceholder: function() {
            ...
            if (window.intlTelInputUtils && shouldSetPlaceholder) {
                ...
                var placeholdernew = placeholder.replace(/\s/g, '');
                this.telInput.attr("placeholder", placeholdernew);
            }
        },
 ...
 ********************/
    ...
    var allCountries = [ [ "Iraq (‫العراق‬‎)", "iq", "964" ] ,
