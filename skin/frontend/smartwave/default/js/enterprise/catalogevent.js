...
Object.extend(Enterprise.CatalogEvent.Ticker.prototype, {
    ...
    applyTimer: function () {
        ...
        if (daySec > 0) {
            ...
            this.container.down('.second').next('span').hide();
            this.container.down('.days').show();
            this.container.down('.days').next('span').show();
        } else {
            this.container.down('.days').hide();
            this.container.down('.days').next('span').hide();
            this.container.down('.second').show();
            this.container.down('.second').next('span').show();
        }
    },
