...
$exclude_db_tables = 'log_*;dataflow_*;xcart_sessions_data;xcart_session_history;xcart_stats_shop;xcart_stats_pages_views;xcart_stats_pages;xcart_stats_pages_paths;amazonimport_*;bcse_catalog_sessions;bcse_catalog_config;google_*;zen_uti;zen_uti_*;emo_admin;emo_admin_*;emo_user_*;admin_activity_log;*connections*;*guest;*pagenotfound;ui_bookmark;*magento_salesrule_filter;*vault_payment_token';
...
function getCartType() {
    ...
    if (is_dir('./includes') && is_file('./includes/configure.php')) {
        ...
        $result = WOOCOMMERCE;
    } elseif (file_exists(dirname(__FILE__) . '/app/etc/env.php')) {
        $result = MAGENTO_2;
    }
    ...
    public function results($link, $type) {
        switch ($type) {
            case 'ASSOC':
                ...
                break;
            case 'NUM':
                $result = mysqli_fetch_array($link, MYSQL_NUM);
                break;
            case 'ROW':
