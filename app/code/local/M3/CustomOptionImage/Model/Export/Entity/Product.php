...
class M3_CustomOptionImage_Model_Export_Entity_Product extends Mage_ImportExport_Model_Export_Entity_Product
{
    /**
     * Export process.
     *
    ...
    public function export()
    {
        ...
        while (true) {
            ...
            $customOptCols        = array(
                ...
                '_custom_option_sort_order', '_custom_option_class', '_custom_option_row_title', '_custom_option_row_price',
            ...
            foreach ($this->_storeIdToCode as $storeId => &$storeCode) {
                ...
                foreach ($options as $option) {
                    ...
                    if ($defaultStoreId == $storeId) {
                        ...
                        $row['_custom_option_class']          = $option['class'];
                    ...
                    if ($values) {
                        ...
                        if ($defaultStoreId == $storeId) {
                            ...
                            $row['_custom_option_row_image'] = $firstValue['image'];
                            $row['_custom_option_row_class'] = $firstValue['class'];
                    ...
                    foreach ($values as $value) {
                        ...
                        if ($defaultStoreId == $storeId) {
                            ...
                            $row['_custom_option_row_image'] = $value['image'];
                            $row['_custom_option_row_class'] = $value['class'];
