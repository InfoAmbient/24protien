...
{  	
	...
	public function viewAction(){
		...
		if($this->getRequest()->isXmlHttpRequest() && (!$this->getRequest()->getParam("fullpageajax") || $this->getRequest()->getParam("ajaxcatalog") || $this->getRequest()->getParam("infinite")))
		{ 
			...
			$productlist = $this->getLayout()->getBlock('products_brand')->toHtml();
