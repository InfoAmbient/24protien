...
class Ves_Brand_Block_Brand_List1 extends Mage_Catalog_Block_Product_List {
  ...
  public function __construct($attributes = array())
  {
    ...
    if(isset($attributes['template']) && $attributes['template']) {
      ...
      $my_template = "ves/brand/brands-home.phtml";
    }
...
//          'link'  =>  Mage::getBaseUrl().$route) );
        ...
        if (isset($filter_group)) {
          ...
          $breadcrumbs->addCrumb( 'venus_group', array( 'label' => $this->getGroup($filter_group)['name'],
          'title' => Mage::helper('ves_brand')->__($this->getGroup($filter_group)['name']),
