...
$read = "sku,name,price,brand,options,options";
...
foreach($products as $product){
	...
	$read_admin = $product->getSku()."##".$product->getName()."##".$product->getFinalPrice()."##".$product->getAttributeText('vesbrand')."##".$onp;
	fputcsv($fx,explode("##",$read_admin));
	
	}else{
		$read_admin = $product->getSku()."##".$product->getName()."##".$product->getFinalPrice()."##".$product->getAttributeText('vesbrand')."##".''."##".'';
		fputcsv($fx,explode("##",$read_admin));
	}
